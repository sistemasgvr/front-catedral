<template>
  <div class="bg-white/95 backdrop-blur-xs rounded-2xl shadow-2xl p-6 border border-[#D39E3A]/30">
    ...
    <div v-else class="space-y-4 max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
      ...
      >
        ...
        <div :class="noticia.imagen ? 'flex gap-4' : ''">
          <!-- Image — clic para ampliar -->
          <div v-if="noticia.imagen" class="flex-shrink-0">
            <img
              :src="noticia.imagen"
              :alt="noticia.titulo"
              class="w-20 h-20 object-cover rounded-lg cursor-zoom-in hover:scale-105 transition-transform shadow-sm"
