  ...
  >
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <Icon icon="mdi:eye-outline" class="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0" aria-hidden="true" />
          Ver
        </button>
        <button
          type="button"
        ...
        >
          <Icon icon="mdi:pencil-outline" class="w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0" aria-hidden="true" />
          Editar
        </button>
        <button
          type="button"
